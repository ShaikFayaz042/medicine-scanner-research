"""
CDSCO Gazette Notifications Page - HTTP Request Test
Target: https://cdsco.gov.in/opencms/opencms/en/Notifications/Gazette-Notifications/
...
OUTPUT_DIR = Path("websites/cdsco-gazette-notifications/http-requests/output")
...
html_file = OUTPUT_DIR / "gazette_page.html"
