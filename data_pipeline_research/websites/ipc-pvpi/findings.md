...
| Year pages followed                  | 11 (2016–2026)                |
| Individual monthly PDFs extracted    | 105 unique                     |
| Years missing from initial crawl     | 0 after 2016 fix              |

Current verified crawl: **105 unique monthly PDFs** across 2016–2026.
...
5. Filter out non-DSA PDFs (sidebar junk, reference-substance lists, forms, and the master index)
6. Merge + dedupe by absolute URL
7. Download each discovered PDF into `html-extraction/output/pdf/`
...
Year link extraction	11 current year links found (2016–2026)	same
Year page crawl	11 pages followed successfully	output/year_pages/
PDF extraction	105 unique PDFs	html-extraction/output/ipc_pdfs.json
PDF download	105 PDFs saved successfully	html-extraction/output/pdf/
