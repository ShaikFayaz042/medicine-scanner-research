#!/usr/bin/env python3
"""
Download every PDF from CDSCO Public Notices page.
Source: https://cdsco.gov.in/opencms/opencms/en/Notifications/Public-Notices/
"""
...
OUT_DIR = cu.ensure_dir(cu.DOWNLOADS_ROOT / "public_notices")
...
def main():
    ...
    for row in tqdm(rows, desc="Public Notices"):
