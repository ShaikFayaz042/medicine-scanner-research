#!/usr/bin/env python3
"""
Download every PDF from CDSCO Gazette Notifications page.
Source: https://cdsco.gov.in/opencms/opencms/en/Notifications/Gazette-Notifications/
"""
...
OUT_DIR = cu.ensure_dir(cu.DOWNLOADS_ROOT / "gazette")
...
def main():
    ...
    for row in tqdm(rows, desc="Gazette"):
